...
@SuppressLint("NewApi") public class ImageTargets extends Activity implements SampleApplicationControl,
    SampleAppMenuInterface
{
    ...
    private void loadTextures()
    {
        mTextures.add(Texture.loadTextureFromApk("TextureTeapotBrass.png",
            getAssets()));
        mTextures.add(Texture.loadTextureFromApk("shroomtexture.png",
            getAssets()));
